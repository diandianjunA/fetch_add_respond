...
#define DEFAULT_LOCAL_CONNECTION_DESC_PATH "/tmp/fetch_add_respond_local_connection_desc_path.txt"
/* Default path to save the remote connection descriptor that should be passed from the other side */
#define DEFAULT_REMOTE_CONNECTION_DESC_PATH "/tmp/fetch_add_request_local_connection_desc_path.txt"
/* Default path to read/save the remote mmap connection descriptor that should be passed to the other side */
#define DEFAULT_REMOTE_RESOURCE_CONNECTION_DESC_PATH "/tmp/fetch_add_respond_remote_resource_desc_path.txt"
